                      ...
                      <div class="shadow sm:rounded-md sm:overflow-hidden">
                        <div class="px-4 py-5 bg-white space-y-6 sm:p-6">
                          ...
                          <div>
                            ...
                            <div class="mt-1">
                              <textarea id="about" name="about" rows="3" class="shadow-sm p-2 focus:ring-indigo-500 focus:border-indigo-500 mt-1 block w-full sm:text-sm border-gray-300 rounded-md" placeholder="This NFT will make you millions, I promise."></textarea>
                            </div>
                          </div>
                          <div className='grid grid-cols-2 gap-8'>
                            <div>
                              ...
                              <div class="mt-1">
                                <div class="mt-1 flex rounded-md shadow-sm">
                                  <input type="number" name="company_website" id="company_website" class="focus:ring-indigo-500 focus:border-indigo-500 flex-1 block w-full rounded rounded sm:text-sm shadow-sm p-2 border-gray-300" placeholder="1000" />
                                </div>
                              </div>
                            </div>
                            <div>
                              ...
                              <div class="mt-1">
                                <div class="mt-1 flex rounded-md shadow-sm">
                                  <input type="number" name="company_website" id="company_website" class="focus:ring-indigo-500 focus:border-indigo-500 flex-1 block w-full rounded sm:text-sm shadow-sm p-2 border-gray-300" placeholder="9" />
                                </div>
                              </div>
                            </div>
                          </div>
